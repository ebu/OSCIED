...
if __name__ == u'__main__':
    ...
    OrchestraLocalConfig().write(u'../oscied-orchestra/local_config.pkl')
    print(u'Write default publisher local configuration')
    PublisherLocalConfig().write(u'../oscied-publisher/local_config.pkl')
    print(u'Write default storage local configuration')
    StorageLocalConfig().write(u'../oscied-storage/local_config.pkl')
    print(u'Write default transform local configuration')
    TransformLocalConfig().write(u'../oscied-transform/local_config.pkl')
    print('Write default web user interface local configuration')
    WebuiLocalConfig().write('../oscied-webui/local_config.pkl')
